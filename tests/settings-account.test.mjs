...
test('sound and reminders use switches, and the sound part is a card of its own',()=>{
 ...
 assert.equal((html.match(/type="checkbox" role="switch"/g)??[]).length,9,'sound, private messages (chat), in-game purchases (the admin only), five notification switches (crops & goods are one, news & offers by email is new; 26 Sep 2026) and full screen');
