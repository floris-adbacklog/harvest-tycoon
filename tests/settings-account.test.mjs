...
test('sound and reminders use switches, and the sound part is a card of its own',()=>{
 ...
 assert.equal((html.match(/type="checkbox" role="switch"/g)??[]).length,8,'sound, private messages (chat), in-game purchases (the admin only), four notification switches (crops & goods are one since 26 Sep 2026) and full screen');
