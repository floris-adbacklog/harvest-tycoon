...
import {createFarm,normalizeFarm,applyFarmAction as act,levelOf,levelProgress,CROPS,RECIPES,recipeDuration,PROJECTS,currentProject,stallStatus,masteryStatus,DAY_MS} from '../game/farm-state.js';
