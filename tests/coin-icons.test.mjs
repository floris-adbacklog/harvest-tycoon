...
test('every button that spends coins on an upgrade shows the coin icon and a number with separators',()=>{
 assert.match(read('public/economy-ui.js'),/\$\{art\('coins'\)\} \$\{number\(cost\)\}`:'Max level'/,'building upgrade: the coin picture and the price, next to the diamond button (26 Sep 2026)');
