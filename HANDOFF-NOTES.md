...
- **Prize produce** (L80): Glasshouse recipe (3 squash, 6 cauliflower, 3 red cabbage, 3 fertilizer → 1, 12 h), sells 6,800; never in the Factory. Used by the fair, exports, Valley Market baskets (a “star”), 2 village orders, 5 commissions, fields 85/90/95, estate upgrade 85, improvements and Estate chapter 10.
...
- **Deploy**: push, then farm-api straight away (rules + new actions). notify-hourly unchanged (no new crop). Tests: `tests/estate-wave3.test.mjs`; 708 pass.
