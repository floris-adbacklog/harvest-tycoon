...
- **Deploy**: push, then farm-api straight away (rules + new actions). notify-hourly unchanged (no new crop). Tests: `tests/estate-wave3.test.mjs`, `tests/balance-expansion.test.mjs`; 714 pass.
