-- Wave 3 (levels 75-90): prize produce, the one new good (grown in the Glasshouse from level 80).
-- 1. Family sharing: prize produce can be gifted and requested like every other item (57 items). Only the items list differs
--    from valley-wave2.sql (whose bodies matched the live functions exactly on 23 Sep 2026: harvest_social prosrc md5
--    d2400439c6d3534f506cdbf59729b474, harvest_public_metrics 9bb1c5bf137df5d9b9f450fc5c45a9c6); limits, checks and the reply
--    are unchanged. tests/family-sharing.test.mjs keeps this list equal to Object.keys(ITEMS).
-- 2. Leaderboards: prize produce counts toward "goods produced". No new crop, so no new column; harvest_commit_farm is untouched.
-- Run after valley-wave2.sql.
