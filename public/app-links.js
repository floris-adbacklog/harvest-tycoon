...
// address. Only these screens, and a chat only by a channel the chat itself knows (global, a family, a private chat).
export const OPEN_SCREENS=Object.freeze(['chat','today','leaderboard','farm']);
const CHANNEL=/^(global|family:[0-9a-f-]{36}|dm:[0-9a-f-]{36}:[0-9a-f-]{36})$/;
