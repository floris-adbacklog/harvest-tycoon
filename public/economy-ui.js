...
export function createEconomyUI({state,onChange,onCrop,onExpand,notify,runAction,onEstate,onFamily}){
 ...
 function renderBuilding(){
  ...
  if(key==='farmhouse'){
   ...
   for(const [rid,r]of Object.entries(RECIPES).filter(([,r])=>r.building===key).sort(([,a],[,b])=>key==='factory'?sourceOf(a)-sourceOf(b):0)){
