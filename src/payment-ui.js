export function showPaymentReturn(bridge){
 ...
 dialog.innerHTML='<h2 id="payment-result-title">Your diamond purchase</h2><p role="status" style="line-height:1.6"></p><button type="button" data-retry>Check payment</button> <button type="button" data-close>Back to farm</button>';
 ...
 async function check(){
  ...
  try{
   ...
   if(result.status==='credited'){
    message.textContent=`Payment confirmed. ${result.diamonds} diamonds have been added to your farm!`;retry.hidden=true;
