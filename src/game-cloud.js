...
if(!bridge){location.replace('/play.html');}else{
 ...
 if(!window.harvestInitialFarm){location.replace('/play.html');}else{
  ...
  const profiles=createPlayerProfiles(bridge);
